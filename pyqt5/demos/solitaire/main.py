...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.scene.setSceneRect(QRectF(0, 0, constants.WINDOW_SIZE[0] - 10, constants.WINDOW_SIZE[1] - 50))
        ...
        self.dealstack.setPos(constants.OFFSET_X + constants.CARD_SPACING_X, constants.OFFSET_Y)
    ...
    def win_animation(self):
        ...
        for card in self.deck:
            if card.vector is not None:
                ...
                if card.pos().y() > constants.WINDOW_SIZE[1] - constants.CARD_DIMENSIONS.height():
