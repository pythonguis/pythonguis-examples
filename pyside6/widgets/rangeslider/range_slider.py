...
from PySide6.QtGui import QBrush, QMouseEvent, QPainter, QPaintEvent, QPalette
...
class RangeSlider(QWidget):
    ...
    def paintEvent(self, event: QPaintEvent):
        ...
        groove_rect = self.style().subControlRect(QStyle.ComplexControl.CC_Slider, self.opt, QStyle.SubControl.SC_SliderGroove)
    ...
    def sizeHint(self):
        ...
        if (
            self.opt.tickPosition.value & QSlider.TickPosition.TicksAbove.value
            or self.opt.tickPosition.value & QSlider.TickPosition.TicksBelow.value
        ):
            h += TickSpace
