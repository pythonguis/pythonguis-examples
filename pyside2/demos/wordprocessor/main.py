...
class MainWindow(QMainWindow):
    ...
    def file_save(self):
        ...
        text = self.editor.toHtml() if utils.splitext(self.path) in constants.HTML_EXTENSIONS else self.editor.toPlainText()
    ...
    def file_saveas(self):
        ...
        text = self.editor.toHtml() if utils.splitext(path) in constants.HTML_EXTENSIONS else self.editor.toPlainText()
